...
export default async function Salons({ searchParams }: { searchParams: Promise<{ q?: string; city?: string }> }) {
  ...
  return <>
    ...
    <main className="shell section salons-index">
      <div className="page-heading"><div><p className="eyebrow">Salon kataloqu</p><h1>Salonları kəşf et</h1><p className="muted">{salons.length} nəticə · aktiv salonlar və real xidmətlər</p></div></div>
